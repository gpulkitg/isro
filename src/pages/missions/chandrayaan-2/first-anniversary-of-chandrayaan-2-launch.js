...
export const query = graphql`
  query {
    chandrayaan2FirstAnniversaryOfChandrayaan2LaunchYaml {
      # cover {
      #   title
      #   image {
      #     name
...
export default function Chandrayaan2FirstAnniversaryOfChandrayaan2Launch({ data }) {

  const {
    // cover,
    title,
    sections,
  } = data.chandrayaan2FirstAnniversaryOfChandrayaan2LaunchYaml
